...
def get_norm_params(path):
    try:
        # mesh = trimesh.load(path.replace('march_cube_objs_v1', 'mesh') + '/model.obj',
        #                     skip_materials=True, process=False,
        #                     force='mesh')
        mesh = trimesh.load(path, skip_materials = True, process=False,
                            force='mesh')
...
if __name__=='__main__':
    ...
    parser.add_argument('--categories', nargs='+', default=['04379243'])
    # parser.add_argument('--categories', nargs='+',
    #                     default=['02691156', '02828884', '02958343', '03001627', '03636649', '04090263', '04379243',
    #                              '04530566'])
    # "watercraft": "04530566",船舶
    # default=['02691156', '02828884', '02933112',
    # '02958343', '03001627', '03211117', '03636649',
    # '03691459', '04090263', '04256520', '04379243',
    # '04401088', '04530566']
    # "rifle": "04090263",步枪
    # "display": "03211117",显示器
    # "lamp": "03636649",灯
    # "speaker": "03691459",扬声器
    # "cabinet": "02933112",储藏柜
    # "chair": "03001627",椅子
    # "bench": "02828884",长椅
    # "car": "02958343",汽车
    # "airplane": "02691156",飞机
    # "sofa": "04256520",沙发
    # "table": "04379243",桌子
    # "phone": "04401088",电话
    # shapenet for shapenet; # pix3d for pix3d
    # parser.add_argument('--exp_name', type=str)
    parser.add_argument('--file_path_glob', type=str, default='/*/*.obj', help='Path of the file from instance ID -> /<instance>*/*filename.ext')
