...
class LIHS(nn.Module):
    def __init__(self, config):
        super(LIHS, self).__init__()
    ...
    def forward(self, img, query, grass_data_80d, trans_mat=None):
        ...
        sdf = self.sdf_decoder(query, vox_feat, feat_local_perceptual,  grass_data_80d)
